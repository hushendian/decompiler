.class public Lcom/yuelan/dreampay/thread/CloseExitDialogTimesThread;
...
.method public run()V
    ...
    const-string v1, "/api/showStsapi4ad.do"
    ...
    invoke-virtual {p0, v0}, Lcom/yuelan/dreampay/thread/CloseExitDialogTimesThread;->doSafeBaseHttp(Ljava/lang/String;)Ljava/lang/String;
