.class public Lcom/yuelan/dreampay/thread/ErrorRecodeThread;
...
.method public run()V
    ...
    const-string v1, "/receiveErrorapirecerror.do?"
    ...
    invoke-virtual {p0, v0}, Lcom/yuelan/dreampay/thread/ErrorRecodeThread;->doSafeBaseHttp(Ljava/lang/String;)Ljava/lang/String;
