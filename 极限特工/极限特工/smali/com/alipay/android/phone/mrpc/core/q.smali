...
.method private d()Lcom/alipay/android/phone/mrpc/core/u;
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->b:Landroid/content/Context;
    ...
    const-string v5, "The network is not available"

    invoke-direct {v1, v2, v5}, Lcom/alipay/android/phone/mrpc/core/HttpException;-><init>(Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/HttpException;->getCode()I

    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/HttpException;->getMsg()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/o;->d()Ljava/util/ArrayList;
    ...
    invoke-interface {v5, v1}, Lorg/apache/http/client/methods/HttpUriRequest;->addHeader(Lorg/apache/http/Header;)V
    :try_end_1
    ...
    invoke-static {v1}, Lcom/alipay/android/phone/mrpc/core/b;->a(Lorg/apache/http/HttpRequest;)V

    invoke-direct {p0}, Lcom/alipay/android/phone/mrpc/core/q;->c()Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v1

    invoke-static {v1}, Lcom/alipay/android/phone/mrpc/core/b;->b(Lorg/apache/http/HttpRequest;)V
    ...
    invoke-interface {v1, v2, v5}, Lorg/apache/http/client/methods/HttpUriRequest;->addHeader(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->g:Lorg/apache/http/protocol/HttpContext;
    ...
    invoke-interface {v1, v2, v5}, Lorg/apache/http/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->a:Lcom/alipay/android/phone/mrpc/core/l;

    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/l;->a()Lcom/alipay/android/phone/mrpc/core/b;

    move-result-object v1

    sget-object v2, Lcom/alipay/android/phone/mrpc/core/q;->e:Lorg/apache/http/client/HttpRequestRetryHandler;

    invoke-virtual {v1, v2}, Lcom/alipay/android/phone/mrpc/core/b;->a(Lorg/apache/http/client/HttpRequestRetryHandler;)V
    ...
    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/b;->getParams()Lorg/apache/http/params/HttpParams;
    ...
    invoke-direct {v1, v9, v10}, Lorg/apache/http/HttpHost;-><init>(Ljava/lang/String;I)V
    ...
    :cond_6
    invoke-interface {v7, v8, v1}, Lorg/apache/http/params/HttpParams;->setParameter(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/params/HttpParams;

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->k:Lorg/apache/http/HttpHost;
    ...
    invoke-direct {v1, v2}, Lorg/apache/http/HttpHost;-><init>(Ljava/lang/String;)V
    ...
    iget-object v8, p0, Lcom/alipay/android/phone/mrpc/core/q;->g:Lorg/apache/http/protocol/HttpContext;

    invoke-virtual {v2, v1, v7, v8}, Lcom/alipay/android/phone/mrpc/core/b;->execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    invoke-virtual {v1, v5, v6}, Lcom/alipay/android/phone/mrpc/core/l;->b(J)V

    iget-object v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->h:Lorg/apache/http/client/CookieStore;
    ...
    invoke-virtual {v5}, Lcom/alipay/android/phone/mrpc/core/o;->e()Z
    ...
    invoke-virtual {v6, v7, v1}, Landroid/webkit/CookieManager;->setCookie(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v1}, Lcom/alipay/android/phone/mrpc/core/HttpException;-><init>(Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v7, v8, v1}, Lorg/apache/http/HttpHost;-><init>(Ljava/lang/String;ILjava/lang/String;)V

    iput-object v2, p0, Lcom/alipay/android/phone/mrpc/core/q;->k:Lorg/apache/http/HttpHost;
    ...
    invoke-direct {v1, v5, v2}, Lcom/alipay/android/phone/mrpc/core/HttpException;-><init>(Ljava/lang/Integer;Ljava/lang/String;)V
    ...
    :cond_10
    :try_start_4
    invoke-direct {p0, v2, v5, v6}, Lcom/alipay/android/phone/mrpc/core/q;->a(Lorg/apache/http/HttpResponse;ILjava/lang/String;)Lcom/alipay/android/phone/mrpc/core/u;
    ...
    invoke-virtual {v2}, Lcom/alipay/android/phone/mrpc/core/u;->b()[B
    ...
    instance-of v1, v2, Lcom/alipay/android/phone/mrpc/core/p;
    ...
    :try_start_5
    invoke-virtual {v1}, Lcom/alipay/android/phone/mrpc/core/p;->a()Lcom/alipay/android/phone/mrpc/core/HttpUrlHeader;

    move-result-object v1

    const-string v5, "Content-Length"

    invoke-virtual {v1, v5}, Lcom/alipay/android/phone/mrpc/core/HttpUrlHeader;->getHead(Ljava/lang/String;)Ljava/lang/String;
