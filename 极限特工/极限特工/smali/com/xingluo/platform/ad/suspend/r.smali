.class Lcom/xingluo/platform/ad/suspend/r;
...
.method constructor <init>(Lcom/xingluo/platform/ad/suspend/XLSuspensionView;IILjava/util/List;Landroid/support/v4/view/ViewPager;)V
    ...
    iput-object p1, p0, Lcom/xingluo/platform/ad/suspend/r;->h:Lcom/xingluo/platform/ad/suspend/XLSuspensionView;

    iput p2, p0, Lcom/xingluo/platform/ad/suspend/r;->i:I

    iput p3, p0, Lcom/xingluo/platform/ad/suspend/r;->j:I

    iput-object p4, p0, Lcom/xingluo/platform/ad/suspend/r;->k:Ljava/util/List;

    iput-object p5, p0, Lcom/xingluo/platform/ad/suspend/r;->l:Landroid/support/v4/view/ViewPager;

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->a:Landroid/widget/ImageView;

    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->b:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->c:Landroid/widget/LinearLayout;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->d:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->e:Ljava/util/List;

    new-instance v0, Landroid/widget/LinearLayout$LayoutParams;

    invoke-direct {v0, v2, v2}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->f:Landroid/widget/LinearLayout$LayoutParams;

    new-instance v0, Landroid/widget/LinearLayout$LayoutParams;

    invoke-direct {v0, v3, v3}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    iput-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->g:Landroid/widget/LinearLayout$LayoutParams;
...
.method protected varargs a([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->f:Landroid/widget/LinearLayout$LayoutParams;

    iget-object v1, p0, Lcom/xingluo/platform/ad/suspend/r;->h:Lcom/xingluo/platform/ad/suspend/XLSuspensionView;
    ...
    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->g:Landroid/widget/LinearLayout$LayoutParams;
    ...
    iget-object v2, p0, Lcom/xingluo/platform/ad/suspend/r;->h:Lcom/xingluo/platform/ad/suspend/XLSuspensionView;
    ...
    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->c:Landroid/widget/LinearLayout;

    invoke-virtual {v0}, Landroid/widget/LinearLayout;->removeAllViews()V

    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->d:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->e:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->h:Lcom/xingluo/platform/ad/suspend/XLSuspensionView;
...
.method protected a(Ljava/lang/Void;)V
    ...
    :goto_0
    iget v0, p0, Lcom/xingluo/platform/ad/suspend/r;->i:I

    if-lt v1, v0, :cond_1

    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->l:Landroid/support/v4/view/ViewPager;

    new-instance v1, Lcom/xingluo/platform/ad/suspend/XLSuspensionView$d;

    iget-object v3, p0, Lcom/xingluo/platform/ad/suspend/r;->h:Lcom/xingluo/platform/ad/suspend/XLSuspensionView;

    iget-object v4, p0, Lcom/xingluo/platform/ad/suspend/r;->d:Ljava/util/List;
    ...
    iget-object v4, p0, Lcom/xingluo/platform/ad/suspend/r;->e:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->k:Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->b:Landroid/widget/LinearLayout;
    ...
    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->a:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, Lcom/xingluo/platform/ad/suspend/r;->a:Landroid/widget/ImageView;
    ...
    iget-object v4, p0, Lcom/xingluo/platform/ad/suspend/r;->g:Landroid/widget/LinearLayout$LayoutParams;

    invoke-virtual {v0, v3, v4}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v0, p0, Lcom/xingluo/platform/ad/suspend/r;->d:Ljava/util/List;

    iget-object v3, p0, Lcom/xingluo/platform/ad/suspend/r;->b:Landroid/widget/LinearLayout;
    ...
    iget v4, p0, Lcom/xingluo/platform/ad/suspend/r;->j:I

    if-ge v0, v4, :cond_3

    iget-object v4, p0, Lcom/xingluo/platform/ad/suspend/r;->b:Landroid/widget/LinearLayout;

    iget-object v5, p0, Lcom/xingluo/platform/ad/suspend/r;->h:Lcom/xingluo/platform/ad/suspend/XLSuspensionView;
    ...
    iget-object v5, p0, Lcom/xingluo/platform/ad/suspend/r;->f:Landroid/widget/LinearLayout$LayoutParams;
    ...
    iget-object v1, p0, Lcom/xingluo/platform/ad/suspend/r;->k:Ljava/util/List;
...
.method protected varargs synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/xingluo/platform/ad/suspend/r;->a([Ljava/lang/Void;)Ljava/lang/Void;
...
.method protected synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/xingluo/platform/ad/suspend/r;->a(Ljava/lang/Void;)V
